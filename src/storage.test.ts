...
import type { CalibrationProfile, SavedData, StringRecord } from './domain';
...
const record: StringRecord = { id: 'r1', startedAt: '2026-09-21', delaySeconds: 2, config: DEFAULT_CONFIG, profile, shots: [], durationMs: 1000, interrupted: false };
describe('device storage', () => {
  it('round trips settings, profiles, and zero-shot strings', () => {
  ...
  it('limits retention to 100 newest strings', () => {
